...
var con = mysql.createConnection({
  ...
  user: "C4131S18U85", // replace with the database user provided to you
  password: "90", // replace with the database password provided to you
  database: "C4131S18U85", // replace with the database user provided to you
  port: 3306
});
